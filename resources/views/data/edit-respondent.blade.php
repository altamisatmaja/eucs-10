                    ...
                    <div class="p-6">
                        <form method="POST" action="{{ route('data.updateRespondent', $id) }}">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-5 gap-4 items-center">
                                        ...
                                        <div class="md:col-span-3">
                                            <input id="{{ $variable }}" type="text"
                                                ...
                                                name="{{ $variable }}"
                                                value="{{ old($variable, $data[$variable] ?? '') }}" required>
                                            @error($variable)
                            ...
                            <div class="flex items-center justify-end mt-8 space-x-3">
                                ...
                                <button type="submit"
                                    class="px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                    Simpan Perubahan
                                </button>
                            </div>
                        </form>
